 ...
 * 
 * @Override public void createCustomer(Customer c) { String fileName; if
 * (c.getUsername() != null) { fileName = c.getUsername() + "Customer.dat"; }
 ...
 * 
 * @Override public Customer readCustomer(String username) { String fileName =
 * username + "Customer.dat"; Customer ret = null; try (FileInputStream fis =
 * new FileInputStream(fileName); ObjectInputStream ois = new
 * ObjectInputStream(fis);) { ret = (Customer) ois.readObject(); } catch
