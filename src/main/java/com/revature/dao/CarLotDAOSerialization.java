 ...
 * 
 * @Override public void createCarLot(List<String> c) { String fileName =
 * "CarLot.dat"; try (FileOutputStream fos = new FileOutputStream(fileName);
 ...
 * }
 * 
 * @Override public List<String> readCarLotList() { String fileName =
 * "CarLot.dat"; List<String> ret = null; try (FileInputStream fis = new
